...
select round((datediff(termdate, hire_date))/365,0) as avg_length_employment
from hr where termdate <= curdate() and termdate <> '' and age >=18;
...
-- 8. Whichdepartmant has the highest turnover rate?
